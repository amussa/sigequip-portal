CREATE MATERIALIZED VIEW vw_period_movements_after_20210901
...
FROM vw_period_soh_and_cmm_after_20210901 stock_cards_soh_cmm) as vm
WITH NO DATA;

-- View indexes:
CREATE UNIQUE INDEX idx_vw_period_movements_after_20210901 ON vw_period_movements_after_20210901(uuid);
CREATE INDEX idx_vw_period_movements_after_20210901_drug_prc_dtc_fcc ON vw_period_movements_after_20210901(drug_code text_ops,province_code text_ops, district_code text_ops, facility_code text_ops);


-- Create refresh functions
CREATE OR REPLACE FUNCTION refresh_period_movements_after_20210901()
  RETURNS INT LANGUAGE plpgsql
AS $$
BEGIN
  REFRESH MATERIALIZED VIEW CONCURRENTLY vw_period_movements_after_20210901;
  RETURN 1;
END $$;